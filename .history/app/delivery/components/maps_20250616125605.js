...
export default function Maps() {
  ...
  const handleEnviar = async (id) => {
    const imprimirTicket = (pedido) => {
      ...
      ticket += "-----------------------------\n";
      ticket += `Cliente: ${pedido.nombre}\n`;
      ticket += `Dirección: ${pedido.direccion}\n`;
      ticket += `Fecha: ${pedido.fecha}\n`;
      ticket += `Pago: ${pedido.formaDePago}\n`;
      ticket += `Observación: ${pedido.observacion || "Ninguna"}\n`;
      ticket += "-----------------------------\n";
