      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
          ...
          <div className="bg-yellow-100 border border-yellow-400 text-yellow-700 px-4 py-2 rounded-lg text-sm">
            <p><strong>⚠️ Aviso:</strong> Los mapas están temporalmente deshabilitados</p>
            ...
            <div className="bg-white text-black p-6 rounded-2xl max-w-lg w-full shadow-2xl relative">
              ...
              <div className="space-y-2 text-sm">
                ...
                {detalle.tipo === "delivery" && (
                  <div className="mt-3">
                    <a
                      href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(detalle.direccion)}`}
                      target="_blank"
