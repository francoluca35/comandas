          ...
          <button
            onClick={async () => {
              try {
                ...
                if (res.ok) {
                  alert("Pedido marcado como entregado y eliminado de cocina");
                } else {
                  alert("No se pudo eliminar el pedido de cocina");
                }
              } catch (err) {
                console.error("Error al eliminar de cocina:", err);
                alert("Error al eliminar el pedido de cocina");
              }
            }}
