  ...
  return (
    <div className="space-y-4">
      ...
      <div className="relative h-64 bg-gray-200 rounded-lg overflow-hidden">
        <iframe
          src={`https://www.openstreetmap.org/export/embed.html?bbox=${coordenadas.lng - 0.01},${coordenadas.lat - 0.01},${coordenadas.lng + 0.01},${coordenadas.lat + 0.01}&layer=mapnik&marker=${coordenadas.lat},${coordenadas.lng}`}
          width="100%"
          height="100%"
          frameBorder="0"
          scrolling="no"
