...
export default function UserDropdown() {
  ...
  return (
    <>
      ...
      <div
        className={`fixed top-0 right-0 sm:left-0 h-full w-[260px] bg-gradient-to-br from-[#4e8eff] to-[#5cd8ff] z-50 shadow-lg transform transition-transform duration-300 rounded-r-3xl ${
