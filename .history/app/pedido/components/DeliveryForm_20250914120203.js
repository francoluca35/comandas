    ...
    try {
      ...
      if (res.ok) {
        ...
        if (tieneBrasas && tieneNoBrasas) {
          ...
          // Solo brasas: 2 tickets - parrilla (SIN precio) y cocina (CON precio)
          console.log("🔥 Solo brasas: enviando 2 tickets");
          console.log("🔥 Enviando brasas a parrilla (192.168.1.101) - SIN precio");
          await enviarAImpresoraDelivery(productosBrasas, "192.168.1.101", "parrilla", false);
          console.log("🍽️ Enviando brasas a cocina (192.168.1.100) - CON precio");
          await enviarAImpresoraDelivery(productosBrasas, "192.168.1.100", "cocina", true);
