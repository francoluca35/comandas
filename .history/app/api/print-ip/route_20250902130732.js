...
export async function POST(req) {
  try {
    ...
    const { ip, nombre, direccion, observacion, productos, total, hora, fecha, metodoPago, modo } = body;
    ...
    const response = await fetch(
      `https://right-worthy-collie.ngrok-free.app/print-ip`, // Ruta específica para impresión por IP
      {
        method: "POST",
