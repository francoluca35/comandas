      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-white/70 text-sm">ID: #{pedido._id?.slice(-6)}</p>
            </div>
          </div>
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 mb-6 border border-white/20 shadow-xl">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-xl font-semibold text-white">Detalles del Pedido</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-white font-medium">{pedido.direccion}</span>
              </div>
              <div className="flex items-center gap-3">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-white font-bold text-lg">${pedido.total}</span>
              </div>
              <div className="flex items-center gap-3">
          ...
          {pedido.observacion && (
            <div className="mt-4 p-4 bg-white/5 rounded-xl border border-white/10">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-white/80 text-sm font-medium">Observación</span>
              </div>
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 mb-6 border border-white/20 shadow-xl">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-xl font-semibold text-white">Ubicación de Entrega</h2>
          </div>
          ...
          <div className="text-center">
            <div className="bg-green-500/20 border border-green-500/30 text-green-300 px-6 py-4 rounded-2xl backdrop-blur-sm">
              <div className="flex items-center justify-center gap-3 mb-2">
                ...
                <span className="font-semibold text-lg">¡Pedido entregado exitosamente!</span>
              </div>
              <p className="text-sm opacity-90">Redirigiendo al panel de delivery...</p>
            </div>
          </div>
        )}
      </div>
