...
export default function ScreenHome() {
  ...
  return (
    <PrivateRoute>
      <main className="min-h-screen bg-gradient-to-br from-[#8B0000] via-black to-[#8B0000] p-8 text-white flex flex-col">
        {/* Header */}
        ...
        {/* Contenido principal */}
        <div className="flex flex-col lg:flex-row justify-center items-center gap-12 flex-grow">
          <TablaMetrica />
          <BotonesMenu />
        </div>
