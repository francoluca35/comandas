          ...
          ${productos
            .map(
              (p) => `<div class="item">
                        ...
                        ${p.observacion ? `<div class="observacion">📝 ${p.observacion}</div>` : ''}
                      </div>`
            )
            .join("")}
          <hr />
    ...
    return (
      <div className="fixed inset-0 bg-black/80 flex items-center justify-center p-4 z-50">
        <div className="bg-white rounded-2xl p-6 space-y-4 w-full max-w-md shadow-lg">
          ...
          <button
            onClick={async () => {
              // 1. Guardar el pedido como ingreso (sin cobrar automáticamente)
              ...
              // ELIMINADO: No se registra ingreso diario automáticamente
              // Se registrará solo cuando se imprima el ticket de pago
              ...
              // ELIMINADO: No se suma efectivo a caja automáticamente
              // Se sumará solo cuando se imprima el ticket de pago
